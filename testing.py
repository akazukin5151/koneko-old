...
def test_split_backslash_last():
    ...
    assert pure.split_backslash_last("https://www.pixiv.net/en/artworks/78823485") == "78823485"


def test_generate_filepath():
    assert pure.generate_filepath("78823485_p0.jpg") == f"{os.path.expanduser('~')}/Downloads/78823485_p0.jpg"
